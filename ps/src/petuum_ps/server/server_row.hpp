...
public:
  ...
  virtual void ApplyBatchIncAccumImportance(const int32_t *column_ids,
  ...
  virtual size_t SerializedSize() const { return row_data_->SerializedSize(); }
  ...
  bool NoClientSubscribed() const { return (num_clients_subscribed_ == 0); }
  ...
  AbstractRow *get_row_data() const { return row_data_; }
