...
AbstractRowOpLog *CreateRowOpLog::CreateDenseRowOpLog(
  ...
  return new DenseRowOpLog(std::bind(&AbstractRow::InitUpdate, sample_row,
                                     std::placeholders::_1,
                                     std::placeholders::_2),
                           std::bind(&AbstractRow::CheckZeroUpdate, sample_row,
                                     std::placeholders::_1),
...
AbstractRowOpLog *CreateRowOpLog::CreateVersionDenseRowOpLog(
    size_t update_size, const AbstractRow *sample_row, size_t row_capacity) {
  return new VersionDenseRowOpLog(std::bind(&AbstractRow::InitUpdate,
...
AbstractRowOpLog *CreateRowOpLog::CreateSparseRowOpLog(
  ...
  return new SparseRowOpLog(std::bind(&AbstractRow::InitUpdate, sample_row,
                                      std::placeholders::_1,
                                      std::placeholders::_2),
                            std::bind(&AbstractRow::CheckZeroUpdate, sample_row,
                                      std::placeholders::_1),
...
AbstractRowOpLog *CreateRowOpLog::CreateSparseVectorRowOpLog(
    size_t update_size, const AbstractRow *sample_row,
    size_t row_capacity __attribute__((unused))) {
  return new SparseVectorRowOpLog(kOpLogRowInitCapacity,
...
AbstractRowOpLog *
CreateRowOpLog::CreateDenseRowOpLogFloat16(size_t update_size,
                                           const AbstractRow *sample_row,
                                           size_t row_oplog_capacity) {
  return new DenseRowOpLogFloat16(std::bind(&AbstractRow::InitUpdate,
                                            sample_row, std::placeholders::_1,
                                            std::placeholders::_2),
                                  std::bind(&AbstractRow::CheckZeroUpdate,
                                            sample_row, std::placeholders::_1),
...
AbstractRowOpLog *CreateRowOpLog::CreateDenseMetaRowOpLog(
    size_t update_size, const AbstractRow *sample_row, size_t row_capacity) {
  return new DenseMetaRowOpLog(std::bind(&AbstractRow::InitUpdate, sample_row,
                                         std::placeholders::_1,
                                         std::placeholders::_2),
                               std::bind(&AbstractRow::CheckZeroUpdate,
                                         sample_row, std::placeholders::_1),
...
AbstractRowOpLog *CreateRowOpLog::CreateVersionDenseMetaRowOpLog(
  ...
  return new VersionDenseMetaRowOpLog(
      std::bind(&AbstractRow::InitUpdate, sample_row, std::placeholders::_1,
                std::placeholders::_2),
      std::bind(&AbstractRow::CheckZeroUpdate, sample_row,
                std::placeholders::_1),
      update_size, row_capacity);
...
AbstractRowOpLog *CreateRowOpLog::CreateSparseMetaRowOpLog(
    size_t update_size, const AbstractRow *sample_row,
    size_t row_capacity __attribute__((unused))) {
  return new SparseMetaRowOpLog(std::bind(&AbstractRow::InitUpdate, sample_row,
                                          std::placeholders::_1,
                                          std::placeholders::_2),
                                std::bind(&AbstractRow::CheckZeroUpdate,
                                          sample_row, std::placeholders::_1),
...
AbstractRowOpLog *
CreateRowOpLog::CreateDenseMetaRowOpLogFloat16(size_t update_size,
                                               const AbstractRow *sample_row,
                                               size_t row_oplog_capacity) {
