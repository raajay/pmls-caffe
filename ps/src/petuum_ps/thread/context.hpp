...
public:
  ...
  static int32_t get_name_node_client_id() { return 0; }
  ...
  static size_t get_row_candidate_factor() { return row_candidate_factor_; }
  ...
  Init(int32_t num_comm_channels_per_client, int32_t num_app_threads,
       ...
       long bg_idle_milli, double client_bandwidth_mbps,
       double server_bandwidth_mbps, size_t thread_oplog_batch_size,
       long server_idle_milli, int32_t row_candidate_factor, int32_t numa_index,
       NumaPolicy numa_policy, bool naive_table_oplog_meta,
       bool use_approx_sort, bool suppression_on) {
  ...
  static int32_t get_num_clients() { return num_clients_; }
  ...
  static double get_client_bandwidth_mbps() { return client_bandwidth_mbps_; }

  static double get_server_bandwidth_mbps() { return server_bandwidth_mbps_; }
  ...
  static int32_t get_numa_index() { return numa_index_; }

  static NumaPolicy get_numa_policy() { return numa_policy_; }

  static bool get_naive_table_oplog_meta() { return naive_table_oplog_meta_; }

  static bool get_suppression_on() { return suppression_on_; }

  static bool get_use_aprox_sort() { return use_approx_sort_; }
