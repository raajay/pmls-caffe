...
public:
  SSPPushBgWorker(int32_t id, int32_t comm_channel_idx,
      ...
      : SSPBgWorker(id, comm_channel_idx, tables, init_barrier,
                    create_table_barrier),
        system_clock_mtx_(system_clock_mtx), system_clock_cv_(system_clock_cv),
        system_clock_(system_clock), bg_server_clock_(bg_server_clock) {
