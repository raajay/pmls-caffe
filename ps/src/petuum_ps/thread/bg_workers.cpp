...
void BgWorkers::SignalHandleAppendOnlyBuffer(int32_t table_id,
                                             int32_t channel_idx) {
...
void BgWorkers::TurnOnEarlyComm() { bg_worker_group_->TurnOnEarlyComm(); }

void BgWorkers::TurnOffEarlyComm() { bg_worker_group_->TurnOffEarlyComm(); }
}
