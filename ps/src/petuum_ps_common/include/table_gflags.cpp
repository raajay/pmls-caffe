...
DEFINE_uint64(append_only_buffer_capacity, 1024 * 1024,
...
DEFINE_uint64(client_send_oplog_upper_bound, 100,
              "client send oplog upper bound");
DEFINE_int32(server_table_logic, -1, "server table logic");
DEFINE_bool(version_maintain, true, "version maintain");
