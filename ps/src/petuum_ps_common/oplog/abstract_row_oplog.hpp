...
public:
  AbstractRowOpLog(size_t update_size) : update_size_(update_size) {}
  ...
  virtual const void *
  ParseDenseSerializedOpLog(const void *mem, int32_t *num_updates,
  ...
  virtual const void *
  ParseSparseSerializedOpLog(const void *mem, int32_t const **column_ids,
                             int32_t *num_updates,
