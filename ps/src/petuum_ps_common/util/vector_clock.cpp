...
VectorClock::VectorClock() : min_clock_(-1) {}

VectorClock::VectorClock(const std::vector<int32_t> &ids) : min_clock_(0) {
  int size = ids.size();
...
int32_t VectorClock::get_min_clock() const { return min_clock_; }
