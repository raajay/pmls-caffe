...
if(PS_VERSION STREQUAL "ps-thin")
    message(STATUS "Using ps-thin parameter server")
...
elseif(PS_VERSION STREQUAL "mlfabric")
    message(STATUS "Using mlfabric parameter server")
    add_subdirectory(mlfabric)
    list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${PS_INCLUDE_DIRS})
    list(APPEND Caffe_COMPILE_OPTIONS PUBLIC "-DUSE_PS_THIN")
else()
