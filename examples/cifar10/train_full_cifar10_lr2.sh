...
# Input files:
solver_filename="${script_root_dir}/examples/cifar10/cifar10_full_solver_lr2.prototxt"
# Uncomment this and line-93 if (re-)start training from a snapshot
snapshot_filename="${script_root_dir}/examples/cifar10/cifar10_full_iter_65000.solverstate"
