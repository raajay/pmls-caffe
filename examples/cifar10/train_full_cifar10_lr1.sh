...
# Input files:
solver_filename="${script_root_dir}/examples/cifar10/cifar10_full_solver_lr1.prototxt"
# Uncomment this and line-93 if (re-)start training from a snapshot
snapshot_filename="${script_root_dir}/examples/cifar10/cifar10_full_iter_60000.solverstate"
