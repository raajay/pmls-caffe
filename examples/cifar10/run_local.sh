...
progname=caffe_main.bin
prog_path=${app_dir}/build/tools/${progname}

host_filename="${script_dir}/localmachinefiles"
host_file=$(readlink -f $host_filename)

worker_filename="${script_dir}/localmachinefiles"
...
client_id=0
echo Running client $client_id on localhost
