...
template <typename Dtype> inline char caffe_sign(Dtype val) {
...
template <typename Dtype>
void caffe_gpu_gemv(const int device_id, const CBLAS_TRANSPOSE TransA,
                    const int M, const int N, const Dtype alpha, const Dtype *A,
                    const Dtype *x, const Dtype beta, Dtype *y);

template <typename Dtype>
void caffe_gpu_axpy(const int device_id, const int N, const Dtype alpha,
                    const Dtype *X, Dtype *Y);

template <typename Dtype>
void caffe_gpu_axpby(const int device_id, const int N, const Dtype alpha,
                     const Dtype *X, const Dtype beta, Dtype *Y);
...
template <typename Dtype>
void caffe_gpu_scal(const int device_id, const int N, const Dtype alpha,
                    Dtype *X);
...
template <typename Dtype>
void caffe_gpu_rng_uniform(const int device_id, const int n, const Dtype a,
                           const Dtype b, Dtype *r);

template <typename Dtype>
void caffe_gpu_rng_gaussian(const int device_id, const int n, const Dtype mu,
...
template <typename Dtype>
void caffe_gpu_dot(const int device_id, const int n, const Dtype *x,
...
template <typename Dtype>
void caffe_gpu_scale(const int device_id, const int n, const Dtype alpha,
                     const Dtype *x, Dtype *y);
