...
BoundedSparseProcessStorage::BoundedSparseProcessStorage(size_t capacity,
...
ClientRow *BoundedSparseProcessStorage::Find(int32_t row_id,
...
bool BoundedSparseProcessStorage::Insert(int32_t row_id,
