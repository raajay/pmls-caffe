...
bool BatchIncAppendOnlyBuffer::Inc(int32_t row_id, int32_t col_id,
                                   const void *delta) {
...
void BatchIncAppendOnlyBuffer::InitRead() { read_ptr_ = buff_.get(); }

const void *BatchIncAppendOnlyBuffer::Next(int32_t *row_id,
                                           int32_t const **col_ids,
                                           int32_t *num_updates) {
