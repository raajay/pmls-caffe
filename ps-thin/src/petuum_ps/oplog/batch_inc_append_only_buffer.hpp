...
#include <stdint.h>
#include <petuum_ps/oplog/abstract_append_only_buffer.hpp>
...
public:
  BatchIncAppendOnlyBuffer(int32_t thread_id, size_t capacity,
                           size_t update_size)
  ...
  bool BatchInc(int32_t row_id, const int32_t *col_ids, const void *deltas,
                int32_t num_updates);
